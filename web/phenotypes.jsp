  ...
  <div class="container">
    <div class="row">
      <!-- Post Content Column -->
        <div class="col-lg-8">
            <!-- Title -->
            <h1 class="mt-4">Phenotypes</h1>
            <hr>
            <!-- Post Content -->
            <p class="lead" method="get" name="phenotypeName" action="Phenotype.java"></p>
            <div class="col-sm" id="test1">
                        ...
                        <%
                            Vector<Phenotype> vec = PhenotypeDAO.getAllPhenotypes();
                            for(Phenotype p:vec){
                        %>
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul class="list-unstyled mb-0">
                  ...
                  <li>
                    <a href="phenotypes.jsp" style="color:#551A8B">Phenotypes</a>
                  </li>
                  <li>
