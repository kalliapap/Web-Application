        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    %>
                    <div class="card my-4">
                        <h5 class="card-header">Insert Gene</h5>
                        <div class="card-body">
                            <form method="get" action="AdminInsertServlet">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-secondary" type="submit" value="submit">Insert Gene</button>
                                </span>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card my-4">
                        <h5 class="card-header">Insert Phenotype</h5>
                        <div class="card-body">
                            <form method="get" action="AdminInsertServlet">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-secondary" type="submit" value="submit">Insert Phenotype</button>
                                </span>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card my-4">
                        <h5 class="card-header">Insert Association</h5>
                        <div class="card-body">
                            <form method="get" action="AdminInsertServlet">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-secondary" type="submit" value="submit">Insert Association</button>
                                </span>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <form method="get" action="AdminInsertServlet">
                                ...
                                <input type="password" class="form-control" placeholder="Enter Password" name="psw1" required>
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-secondary" type="submit" value="submit">Create User</button>
                                </span>
                            </form>
                        </div>
                    </div>
